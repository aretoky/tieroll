class Staff::HatController < Staff::Base
  ...
  private
  def hat_params
    params.require(:hat).permit(:price, :size, :color, :pattern, :season, :scene, :description, :raw_materials, :hat_front, :hat_back, :hat_side, :hat_roof, :hat_sole, :hat_inner, :hat_one, :hat_two)
  end
end
