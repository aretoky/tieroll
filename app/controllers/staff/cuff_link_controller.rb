class Staff::CuffLinkController < Staff::Base
  ...
  def cuff_link_params
    params.require(:cuff_link).permit(:price, :size, :color, :pattern, :season, :scene, :description, :raw_materials, :name, :code, :cuff_link_one, :cuff_link_two, :cuff_link_three, :cuff_link_four, :cuff_link_five, :cuff_link_six, :cuff_link_seven)
  end
